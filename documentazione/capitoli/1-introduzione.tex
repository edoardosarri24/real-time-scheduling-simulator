...
\begin{itemize}
    ...
    \item Un chunk campiona il suo tempo di esecuzione da una distribuzione, mentre il task campiona il suo periodo e la deadline. Tale distribuzione, passata come parametro del costruttore, è un oggetto di tipo \texttt{Sampler} definito nella libreria Sirio.
